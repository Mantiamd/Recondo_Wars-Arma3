...
// Objective Photographs global variables
RECONDO_PHOTO_INSTANCES = [];
RECONDO_PHOTO_ACTIVE = [];
RECONDO_PHOTO_COMPLETED = [];
RECONDO_PHOTO_PHOTOGRAPHED = [];
RECONDO_PHOTO_SPAWNED_OBJECTS = [];
RECONDO_PHOTO_TRIGGERS = [];
RECONDO_PHOTO_MARKER_DATA = [];
RECONDO_PHOTO_SMELL_TRIGGERED = [];
RECONDO_PHOTO_NIGHT_LIGHTS_ENABLED = false;
RECONDO_PHOTO_NIGHT_LIGHT_BUILDINGS = [];
RECONDO_PHOTO_ACTIVE_LIGHTS = [];
RECONDO_PHOTO_NIGHT_LIGHT_LOOP_STARTED = false;

// QRF Mounted global variables
RECONDO_QRF_INSTANCES = [];
RECONDO_QRF_ACTIVE_GROUPS = [];
RECONDO_QRF_TRIGGERED_MODULES = [];

// Player Persistence global variables
RECONDO_PLAYER_PERSISTENCE_ENABLED = false;
RECONDO_PLAYER_PERSISTENCE_DEBUG = false;
RECONDO_PLAYER_PERSISTENCE_DELAY = 20;
RECONDO_PLAYER_PERSISTENCE_UNIT_NAMES = [];

// Vehicle Persistence global variables
RECONDO_VEHICLE_PERSISTENCE_UNITS = [];
RECONDO_VEHICLE_PERSISTENCE_DEBUG = false;

// Inventory Persistence global variables
RECONDO_INVENTORY_PERSISTENCE_CONTAINERS = [];
RECONDO_INVENTORY_PERSISTENCE_DEBUG = false;

// Soil Sample global variables
RECONDO_SOIL_SETTINGS = nil;
