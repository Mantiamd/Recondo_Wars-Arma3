/*
    Recondo_fnc_showHostageSmellHint
...
private _lastHintTime = missionNamespace getVariable ["RECONDO_HOSTAGE_LastSmellHintTime", 0];
if (time - _lastHintTime < 8) exitWith {};
missionNamespace setVariable ["RECONDO_HOSTAGE_LastSmellHintTime", time];
