/*
    Recondo_fnc_showHubSubsSmellHint
...
private _lastHintTime = missionNamespace getVariable ["RECONDO_HUBSUBS_LastSmellHintTime", 0];
if (time - _lastHintTime < 8) exitWith {};
missionNamespace setVariable ["RECONDO_HUBSUBS_LastSmellHintTime", time];
