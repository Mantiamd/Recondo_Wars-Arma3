/*
    Recondo_fnc_showJammerSmellHint
...
private _lastHintTime = missionNamespace getVariable ["RECONDO_JAMMER_LastSmellHintTime", 0];
if (time - _lastHintTime < 8) exitWith {};
missionNamespace setVariable ["RECONDO_JAMMER_LastSmellHintTime", time];
